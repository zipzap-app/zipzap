...
const mockPosts: Post[] = [
  { id: "1", userId: "user-1", user: "astro.sky", initials: "AS", color: "#1a3a5c", caption: "Via Lattea dal Gran Sasso — 4 ore di esposizione, zero filtri", hashtags: "#astronomia #fotografia #italia", likes: 41200, comments: 3100, shares: 8700, hasLink: false, linkName: "", linkMeta: "", earn: "", type: "LIBERO", mediaUrl: "", postType: "text" },
  { id: "2", userId: "user-2", user: "mario.reviews", initials: "MR", color: "#0d3320", caption: "Il miglior auricolare sotto i 50€ — recensione onesta dopo 3 mesi", hashtags: "#tech #gadget #recensione", likes: 5600, comments: 387, shares: 1100, hasLink: true, linkName: "Sony WF-1000XM5 · €249", linkMeta: "amazon.it · browser nativo", earn: "+€6", type: "LINK", mediaUrl: "", postType: "text" },
  { id: "3", userId: "user-3", user: "vale.beats", initials: "VB", color: "#3d0a2e", caption: "Beat fatta in 60 secondi con samples di cucina", hashtags: "#musica #produzione #beatmaking", likes: 98000, comments: 14000, shares: 22000, hasLink: false, linkName: "", linkMeta: "", earn: "", type: "LIBERO", mediaUrl: "", postType: "text" },
];
